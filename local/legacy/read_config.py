...
# 
# This script tries to import the config values from config.py and output a JSON object
# 
...
# https://github.com/dwilding/frogtab/blob/f5f2d5436440d9e6eb4af4aadfd7273a95b5cadc/local/config.py
